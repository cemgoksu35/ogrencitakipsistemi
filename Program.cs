        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                if (girisyap == true)
                {
                    ...
                    while (true)
                    {
                        Console.Write("\nAranacak öğrenci numarası giriniz: ");
                        string aranandeger = Console.ReadLine();

                        bool varmi = false;

                    /*    foreach (var ogrenciler in ogrencilers)
                        {
                            varmi = ogrenciler.OgrenciNo.Contains(aranandeger);
                            if (varmi == true)
                            {
                                Console.WriteLine($"Bulundu \nAdı : {ogrenciler.Adi} \nSoyadı : {ogrenciler.Soyadi} \nGeçme Durumu : {ogrenciler.sondurum} \nGeçme Durumu :  {ogrenciler.GectiMi()}");
                         ...
                         else Console.WriteLine("Bulunamadı Tekrar Deneyin"); 
